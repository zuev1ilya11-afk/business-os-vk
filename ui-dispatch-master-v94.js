...
function relocateDispatcherControls(){
  ...
  const dateNav=board.querySelector('.dbDateNav'),quickDates=board.querySelector('.dbV21QuickDates');
...
function renderInlineList(){
  ...
  if(!schedule.querySelector('.dbV94InlineList'))schedule.innerHTML=inlineListHtml();
  syncListTab();relocateDispatcherControls();
}
function enhance(){
  if(enhancing||!dispatcherDesktop())return;enhancing=true;
  try{relocateDispatcherControls();if(inlineListMode)renderInlineList()}finally{enhancing=false}
}
...
.dbV94InlineList{display:grid;grid-template-rows:auto minmax(0,1fr);align-content:stretch;gap:10px;padding:12px;height:100%;min-height:0;box-sizing:border-box}.dbV94ListHead,.dbV94ListTop{display:flex;align-items:center;justify-content:space-between;gap:10px}.dbV94ListHead{align-self:start;padding:2px 2px 8px;border-bottom:1px solid rgba(255,255,255,.08)}.dbV94ListHead span{display:block;color:var(--muted,#91a3b7);font-size:11px}.dbV94ListHead strong{font-size:22px}.dbV94ListItems{display:grid;grid-auto-rows:max-content;gap:7px;align-content:start;min-height:0;overflow:auto;max-height:none;padding-right:2px}.dbV94ListCard{width:100%;height:auto!important;min-height:68px;display:grid;grid-template-rows:auto auto auto;align-content:start;gap:5px;text-align:left;padding:10px;border-radius:11px;border:1px solid rgba(89,157,222,.25);background:#102235;color:inherit;box-sizing:border-box;overflow:visible}.dbV94ListCard:hover{border-color:#4d96d7}.dbV94ListCard.warn{border-color:rgba(245,158,11,.7);background:rgba(245,158,11,.10)}.dbV94ListCard.danger{border-color:rgba(239,68,68,.68);background:rgba(239,68,68,.10)}.dbV94ListCard.done{border-color:rgba(34,197,94,.62);background:rgba(34,197,94,.09)}.dbV94ListCard.cancelled{opacity:.66}.dbV94ListTop{align-items:flex-start}.dbV94ListTop b{font-size:12px;line-height:1.25;overflow-wrap:anywhere}.dbV94Status{flex:0 0 auto;font-size:9px;font-weight:800;padding:3px 6px;border-radius:999px;background:rgba(255,255,255,.08)}.dbV94Status.warn{color:#fcd34d;background:rgba(245,158,11,.15)}.dbV94Status.danger{color:#fca5a5;background:rgba(239,68,68,.15)}.dbV94Status.done{color:#86efac;background:rgba(34,197,94,.15)}.dbV94ListWork{font-size:12px;line-height:1.3;overflow-wrap:anywhere}.dbV94ListMeta{display:flex;gap:4px 8px;flex-wrap:wrap;color:var(--muted,#91a3b7);font-size:10px;line-height:1.3;overflow-wrap:anywhere}.dbV94Empty{padding:30px;text-align:center;color:var(--muted,#91a3b7)}
}
