...
test('production HTML loads and cache-busts live field fixes',()=>{
  ...
  expect(html).toContain('live-field-hotfix-v60.js?v=20260913-audit2');
  expect(html).toContain('employee-form-v16.js?v=20260913-audit2');
  expect(html).toContain('master-memo-runtime-v21.js?v=20260913-audit2');
  expect(html).toContain('manager-memo-editor-v45.js?v=20260913-audit2');
});
