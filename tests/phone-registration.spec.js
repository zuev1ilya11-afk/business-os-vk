...
test('new employee registers by phone without VK ID',async({page})=>{
  ...
  const sessionHandler=route=>route.fulfill({status:200,contentType:'application/json',body:JSON.stringify({ok:true,session_token:'22334455.9999999999.testsig',registration_required:true})});
