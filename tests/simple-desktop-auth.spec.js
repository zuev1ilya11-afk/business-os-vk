...
test('desktop password login creates BOS session and opens app',async({page})=>{
  await page.setViewportSize({width:1280,height:900});
  let loginCalls=0,bootstrapCalls=0;
