...
test('dispatcher mobile schedule shows day load, conflicts and quick actions',async({page})=>{
  ...
  Object.assign(db.tables.orders.find(o=>String(o.id)==='11'),{scheduled_date:'2099-09-10',scheduled_time:'10:00',time_slot:'10:00–11:00',phone:'79990000001'});
  Object.assign(db.tables.orders.find(o=>String(o.id)==='12'),{scheduled_date:'2099-09-10',scheduled_time:'11:00',time_slot:'11:00–12:00',phone:'79990000002'});
  db.tables.orders.push({id:'13',client:'Вера',address:'Невский 2',work:'Карниз',status:'В работе',amount:1500,scheduled_date:'2099-09-10',scheduled_time:'10:30',time_slot:'10:30–11:30',master_staff_id:master.id,master_name:master.full_name,source:'VK'});
  db.tables.staff_schedule.push({staff_id:master.id,work_date:'2099-09-10',is_working:true,work_start:'09:00',work_end:'18:00'});
