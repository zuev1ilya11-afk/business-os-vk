...
const style=document.createElement('style');style.textContent=`.ownerProblemsCompact{min-width:0}.ownerProblemsCompact .ownerProblemRow{display:flex!important;width:100%!important;max-width:100%;min-width:0;padding:12px 14px;align-items:flex-start;justify-content:space-between;gap:10px;text-align:left;white-space:normal!important}.ownerProblemsCompact .dashOrderBody{display:block!important;flex:1 1 auto!important;width:auto!important;min-width:0!important;max-width:calc(100% - 24px)!important}.ownerProblemsCompact .dashArrow{display:block;flex:0 0 auto}.ownerProblemTop{display:flex!important;align-items:center;justify-content:space-between;gap:10px;min-width:0}.ownerProblemTop strong{display:block;flex:1 1 auto;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.ownerProblemTop b{display:block;flex:0 0 auto;white-space:nowrap}.ownerProblemComment{display:block;width:100%;margin:7px 0 8px;font-size:13px;line-height:1.35;text-align:left;color:var(--text,#fff);white-space:normal!important;overflow-wrap:break-word;word-break:normal}.ownerProblemMeta{display:flex!important;width:100%;gap:12px;flex-wrap:wrap;font-size:11px;color:var(--muted,#9badc0);text-align:left;white-space:normal!important}.ownerProblemMeta b{font-size:11px;color:inherit}@media(max-width:520px){.ownerProblemsCompact .ownerProblemRow{padding:11px 12px}.ownerProblemsCompact .dashOrderBody{max-width:calc(100% - 20px)!important}.ownerProblemMeta{gap:5px 10px}.ownerProblemTop strong{font-size:13px}.ownerProblemTop b{font-size:13px}}`;document.head.appendChild(style);
})();